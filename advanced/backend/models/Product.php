...
class Product extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['pro_CatID'], 'exist', 'skipOnError' => true, 'targetClass' => Category::className(), 'targetAttribute' => ['pro_CatID' => 'cat_ID']],
        ];
    }
    ...
    {
        return $this->hasOne(Category::className(), ['cat_ID' => 'pro_CatID']);
    }
}
